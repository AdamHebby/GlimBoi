 ...
 * @return The ID or null if unsuccessful.
 */
 ...
 * @return {Promise<number>} The user ID. If failed returns null
 */
 ...
 * @async
 * Currently unused
 * @return {Promise} The category. If failed returns null
 */
...
async function getStats() {
  const viewers = await new Promise((resolve) => {
 ...
 * @return {Promise} The name of the bot account. If failed returns null.
 */
...
/**
  ...
  * @return {Promise} Returns random advice. If fails returns- "Advice Failed :glimsad:"
  */
async function getAdvice() {
  const advice = await new Promise((resolve) => {
 ...
 * @async
 * Requests a dad joke
 * @return Returns a dad joke. If failed returns- "Joke Failed :glimsad:"
 */
